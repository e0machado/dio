package org.dio.IOBytes.IOData;
...
public class ExemploIOData {
    public static void incluirProduto() throws IOException {
        File f = new File(
                "C:\\Users\\evand\\OneDrive\\Documentos\\dio\\formacao\\java-developer\\io\\arquivos\\peca-de-roupa.bin"
        );
    ...
    public static void lerProduto(String caminhoArquivo) throws IOException {
        ...
        System.out.printf("Quantidde...............: %d\n", quant);
        System.out.printf("Preço...................: %f\n", preco);
        System.out.println("Total valor das peças: R$ " + (quant * preco));
